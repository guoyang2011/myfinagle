...
public abstract class AFamilyService extends AbstractChCareWebApi implements
				...
				.doTask(new Callable<ResponseBean>() {
					...
					public ResponseBean call() {
						...
						try {
							...
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_createFamily_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_createFamily_Service);
						}
						return bean;
					}
				});
	 ...
	 * @throws
	 */
	public abstract ResponseBean inviteJoinFamily(int familyID, String username,String reason)
				...
				.doTask(new Callable<ResponseBean>() {
					...
					public ResponseBean call() {
						...
						try {
							...
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_inviteJoinFamily_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_inviteJoinFamily_Service);
						}
						return bean;
					}
				});
				...
				.doTask(new Callable<ResponseBean>() {
					...
					public ResponseBean call() {
						...
						try {
							...
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_searchFamilys_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_searchFamilys_Service);
						}
						return bean;
					}
				});
	 ...
	 * @throws
	 */
	public abstract ResponseBean applyJoinFamily(int familyID, String username,String reason)
			throws HttpRequestException;
	/**
	 * 异步方式申请加入家庭
	 * [2.4.申请加入家庭]
				...
				.doTask(new Callable<ResponseBean>() {
					...
					public ResponseBean call() {
						...
						try {
							...
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_applyJoinFamily_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_applyJoinFamily_Service);
						}
						return bean;
					}
				});
	 ...
	 * Reason理由
	 *  8.3用户同意: FamilyID指定发生关系的家庭/ UserID指定当前用户/ Allow =
	 * true标志加入家庭的操作同意/ Reason理由 8.4用户拒绝FamilyID指定发生关系的家庭/ UserID指定当前用户/ Allow =
	 * true标志加入家庭的操作拒绝/ Reason理由
	 * [2.5.户主同意/拒绝账户进入家庭  用户同意或者拒绝加入家庭]
				...
				.doTask(new Callable<ResponseBean>() {
					...
					public ResponseBean call() {
						...
						try {
							...
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_joinFamilyAllowByMaster_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_joinFamilyAllowByMaster_Service);
						}
						return bean;
					}
				});
				...
				.doTask(new Callable<ResponseBean>() {
					...
					public ResponseBean call() {
						...
						try {
							...
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_getAllFamilyInfo_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_getAllFamilyInfo_Service);
						}
						return bean;
					}
				});
	...
	public <T> Future<ResponseBean> changeUserFamilyMemberNickName(
			final int fimalyID, final int userID, final String nickname,
			final AsyncResponseCompletedHandler<T> handler) {
		Future<ResponseBean> future = executorProvider
				.doTask(new Callable<ResponseBean>() {
					...
					public ResponseBean call() {
						ResponseBean bean = null;
						try {
							bean = changeUserFamilyMemberNickName(fimalyID,
									userID, nickname);
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_changeUserFamilyMemberNickName_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_changeUserFamilyMemberNickName_Service);
						}
						return bean;
					}
				});
				...
				.doTask(new Callable<ResponseBean>() {
					...
					public ResponseBean call() {
						...
						try {
							...
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_getFamilyMembers_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_getFamilyMembers_Service);
						}
						return bean;
					}
				});
				...
				.doTask(new Callable<ResponseBean>() {
					...
					public ResponseBean call() {
						...
						try {
							...
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_removeUserByMaster_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_removeUserByMaster_Service);
						}
						return bean;
					}
				});
					...
					public ResponseBean call() {
						...
						try {
							bean = updateFamilyInfo(familyID, userID,
									familyName, familySign);
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_updateFamilyInfo_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_updateFamilyInfo_Service);
						}
						return bean;
					}
				});
	 ...
	 * @throws
	 */
	public abstract ResponseBean<?> destroyFamily(int familyID) throws HttpRequestException;
	/**
	 * 异步方式注销当前家庭
	 * [2.12.注销家庭]
	 * @Title: destroyFamily  
	 ...
	 * @throws
	 */
	public <T> Future<ResponseBean<?>> destroyFamily(final int familyID,final AsyncResponseCompletedHandler<T> handler){
		Future<ResponseBean<?>> future = executorProvider
				.doTask(new Callable<ResponseBean<?>>() {
					...
					public ResponseBean call() {
						...
						try {
							...
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_destroyFamily_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_destroyFamily_Service);
						}
						return bean;
					}
				});
	 ...
	 * @throws
	 */
	public abstract ResponseBean<?> uploadFamilyIcon(int familyID,InputStream instream,String filename) throws HttpRequestException;
	public abstract ResponseBean<?> uploadFamilyIcon(int familyID,File file)  throws HttpRequestException;
	public <T> Future<ResponseBean<?>> uploadFamilyIcon(final int familyID,final File file,final AsyncResponseCompletedHandler<T> handler){
		Future<ResponseBean<?>> future = executorProvider
				.doTask(new Callable<ResponseBean<?>>() {
					...
					public ResponseBean call() {
						...
						try {
							...
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_uploadFamilyIcon_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_uploadFamilyIcon_Service);
						}
						return bean;
					}
				});
	 ...
	 * @throws
	 */
	public <T> Future<ResponseBean<?>> uploadFamilyIcon(final int familyID,final InputStream instream,final String filename,final AsyncResponseCompletedHandler<T> handler){
		Future<ResponseBean<?>> future = executorProvider
				.doTask(new Callable<ResponseBean<?>>() {
					...
					public ResponseBean call() {
						ResponseBean bean = null;
						try {
							bean = uploadFamilyIcon(familyID,instream,filename);
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_uploadFamilyIcon_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_uploadFamilyIcon_Service);
						}
	 ...
	 * @throws
	 */
	public abstract ResponseBean<?> getFamilyIcon(int familyID) throws HttpRequestException;
	/**
	 * 异步方式获取家庭头像
	 * [2.14.家庭头像下载(新)]
	 * @Title: getFamilyIcon  
	 ...
	 * @throws
	 */
	public <T> Future<ResponseBean<?>> getFamilyIcon(final int familyID,final AsyncResponseCompletedHandler<T > handler){
		Future<ResponseBean<?>> future = executorProvider
				.doTask(new Callable<ResponseBean<?>>() {
					...
					public ResponseBean call() {
						...
						try {
							...
							handler.onCompleted(bean,ChCareWepApiServiceType.WebApi_Family_getFamilyIcon_Service);
						} catch (HttpRequestException e) {
							handler.onThrowable(e,ChCareWepApiServiceType.WebApi_Family_getFamilyIcon_Service);
						}
						return bean;
					}
				});
