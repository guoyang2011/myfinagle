...
trait CHRequest{
  ...
  var clientType:Option[Int]
  var tokenType:Option[Int]
  var urlParams:Option[java.util.Map[String,java.util.List[String]]]

}
case class RequestBean() extends CHRequest {
  override var request: HttpRequest = _
  override var tokenType: Option[Int] = _
  override var accessToken: Option[String] = _
  override var userId: Option[Long] = _
  override var clientId: String = _
  override var path: String = _
  override var urlParams: Option[java.util.Map[String,java.util.List[String]]] = _
  override var clientType: Option[Int] = _
}
